...
import { ArrowUpDown, Search } from "lucide-react"; // Opcional: Ícones (instale lucide-react ou use os seus)
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div
        ...
        className={`relative overflow-auto border rounded-md bg-white ${className}`}
      >
